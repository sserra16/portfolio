...
export default function BackgroundCircles({}: Props) {
  return (
    <motion.div 
      ...
      <div className="absolute border border-[#333333] rounded-full h-[500px] w-[500px] mt-60 animate-ping" />
      <div className="rounded-full border border-[#1DA4AD] opacity-2 h-[650px] w-[650px] absolute mt-60 animate-pulse" />
